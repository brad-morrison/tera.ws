...
case h.color:return"color";case h.luminosity:return"luminosity"}}function a(l){return"rgba("+((16711680&l)>>>16)+","+((65280&l)>>>8)+","+((255&l)>>>0)+","+((4278190080&l)>>>24)/255+")"}function c(){0<E.length&&(fa.eb(A.drawWidth(),A.drawHeight(),E,N,Y),E=[],Y=N=0,A.reset(512,512));for(const l of v){for(const r of l.ea)r();l.ea=[]}v.clear()}var d=Rive.RenderPaintStyle;const e=Rive.RenderPath,f=Rive.RenderPaint,n=Rive.Renderer,g=Rive.StrokeCap,m=Rive.StrokeJoin,h=Rive.BlendMode,p=d.fill,u=d.stroke,
...
r,y){var C=l.Wa;if(C){var B=this.$,I=b(r);this.ea.push(function(){B.globalCompositeOperation=I;B.globalAlpha=y;B.drawImage(C,0,0);B.globalAlpha=1})}},_getMatrix:function(l){const r=this.ga,y=r.length-6;for(let C=0;6>C;++C)l[C]=r[y+C]},_drawImageMesh:function(l,r,y,C,B,I,K,R,T,S){var U=this.$.canvas.width,H=this.$.canvas.height;const tb=T-K,ub=S-R;K=Math.max(K,0);R=Math.max(R,0);T=Math.min(T,U);S=Math.min(S,H);const ta=T-K,ua=S-R;console.assert(ta<=Math.min(tb,U));console.assert(ua<=Math.min(ub,H));
if(!(0>=ta||0>=ua)){T=ta<tb||ua<ub;U=S=1;var ja=Math.ceil(ta*S),ka=Math.ceil(ua*U);H=fa.qb();ja>H&&(S*=H/ja,ja=H);ka>H&&(U*=H/ka,ka=H);A||(A=new k.DynamicRectanizer(H),A.reset(512,512));H=A.addRect(ja,ka);0>H&&(c(),v.add(this),H=A.addRect(ja,ka),console.assert(0<=H));var vb=H&65535,wb=H>>16;E.push({ma:this.ga.slice(this.ga.length-6),image:l,Ha:vb,Ia:wb,rb:K,sb:R,Ab:ja,Na:ka,ta:S,ua:U,Da:new Float32Array(C),Ua:new Float32Array(B),qa:new Uint16Array(I),tb:T,Ra:l.xa<<1|(T?1:0)});N+=C.length;Y+=I.length;
var oa=this.$,$b=b(r);this.ea.push(function(){oa.save();oa.resetTransform();oa.globalCompositeOperation=$b;oa.globalAlpha=y;oa.drawImage(fa.canvas(),vb,wb,ja,ka,K,R,ta,ua);oa.restore()})}},_clipPath:function(l){this.ea.push(this.$.clip.bind(this.$,l.ha,l.Fa===t?"evenodd":"nonzero"))},clear:function(){v.add(this);this.ea.push(this.$.clearRect.bind(this.$,0,0,this.Ea.width,this.Ea.height))},flush:function(){},translate:function(l,r){this.transform({xx:1,xy:0,yx:0,yy:1,tx:l,ty:r})}});Rive.makeRenderer=
...
d.bb;d.Oa=c};var ha={},ia;for(ia in k)k.hasOwnProperty(ia)&&(ha[ia]=k[ia]);var la="object"===typeof window,ma="function"===typeof importScripts,w="",na,pa;
if(la||ma)ma?w=self.location.href:"undefined"!==typeof document&&document.currentScript&&(w=document.currentScript.src),_scriptDir&&(w=_scriptDir),0!==w.indexOf("blob:")?w=w.substr(0,w.replace(/[?#].*/,"").lastIndexOf("/")+1):w="",ma&&(pa=function(b){var a=new XMLHttpRequest;a.open("GET",b,!1);a.responseType="arraybuffer";a.send(null);return new Uint8Array(a.response)}),na=function(b,a,c){var d=new XMLHttpRequest;d.open("GET",b,!0);d.responseType="arraybuffer";d.onload=function(){200==d.status||0==
d.status&&d.response?a(d.response):c()};d.onerror=c;d.send(null)};var qa=k.print||console.log.bind(console),ra=k.printErr||console.warn.bind(console);for(ia in ha)ha.hasOwnProperty(ia)&&(k[ia]=ha[ia]);ha=null;var sa;k.wasmBinary&&(sa=k.wasmBinary);var noExitRuntime=k.noExitRuntime||!0;"object"!==typeof WebAssembly&&va("no native wasm support detected");var wa,xa=!1,ya="undefined"!==typeof TextDecoder?new TextDecoder("utf8"):void 0;
...
var Ua=0,Va=null,Wa=null;k.preloadedImages={};k.preloadedAudios={};function va(b){if(k.onAbort)k.onAbort(b);b="Aborted("+b+")";ra(b);xa=!0;b=new WebAssembly.RuntimeError(b+". Build with -s ASSERTIONS=1 for more info.");ba(b);throw b;}function Xa(){return M.startsWith("data:application/octet-stream;base64,")}var M;M="canvas_advanced.wasm";if(!Xa()){var Ya=M;M=k.locateFile?k.locateFile(Ya,w):w+Ya}
function Za(){var b=M;try{if(b==M&&sa)return new Uint8Array(sa);if(pa)return pa(b);throw"both async and sync fetching of the wasm failed";}catch(a){va(a)}}
function $a(){if(!sa&&(la||ma)){if("function"===typeof fetch&&!M.startsWith("file://"))return fetch(M,{credentials:"same-origin"}).then(function(b){if(!b.ok)throw"failed to load wasm binary file at '"+M+"'";return b.arrayBuffer()}).catch(function(){return Za()});if(na)return new Promise(function(b,a){na(M,function(c){b(new Uint8Array(c))},a)})}return Promise.resolve().then(function(){return Za()})}
...
var O=[{},{value:void 0},{value:null},{value:!0},{value:!1}],eb=[];function fb(b){var a=Error,c=db(b,function(d){this.name=b;this.message=d;d=Error(d).stack;void 0!==d&&(this.stack=this.toString()+"\n"+d.replace(/^Error(:[^\n]*)?\n/,""))});c.prototype=Object.create(a.prototype);c.prototype.constructor=c;c.prototype.toString=function(){return void 0===this.message?this.name:this.name+": "+this.message};return c}var gb=void 0;function P(b){throw new gb(b);}
function hb(b){b||P("Cannot use deleted val. handle = "+b);return O[b].value}function Q(b){switch(b){case void 0:return 1;case null:return 2;case !0:return 3;case !1:return 4;default:var a=eb.length?eb.pop():O.length;O[a]={Ba:1,value:b};return a}}var ib=void 0,jb=void 0;function V(b){for(var a="";D[b];)a+=jb[D[b++]];return a}var kb=[];function lb(){for(;kb.length;){var b=kb.pop();b.V.la=!1;b["delete"]()}}var mb=void 0,nb={};
function ob(b,a){for(void 0===a&&P("ptr should not be undefined");b.aa;)a=b.oa(a),b=b.aa;return a}var pb={};function qb(b){b=rb(b);var a=V(b);sb(b);return a}function xb(b,a){var c=pb[b];void 0===c&&P(a+" has unknown type "+qb(b));return c}function yb(){}var zb=!1;function Ab(b){--b.count.value;0===b.count.value&&(b.ba?b.da.ia(b.ba):b.Y.W.ia(b.X))}
function Bb(b){if("undefined"===typeof FinalizationGroup)return Bb=function(a){return a},b;zb=new FinalizationGroup(function(a){for(var c=a.next();!c.done;c=a.next())c=c.value,c.X?Ab(c):console.warn("object already deleted: "+c.X)});Bb=function(a){zb.register(a,a.V,a.V);return a};yb=function(a){zb.unregister(a.V)};return Bb(b)}var Cb={};function Db(b){for(;b.length;){var a=b.pop();b.pop()(a)}}function Eb(b){return this.fromWireType(L[b>>2])}var Fb={},Gb={},Hb=void 0;
function Ib(b){throw new Hb(b);}function W(b,a,c){function d(g){g=c(g);g.length!==b.length&&Ib("Mismatched type converter count");for(var m=0;m<b.length;++m)X(b[m],g[m])}b.forEach(function(g){Gb[g]=a});var e=Array(a.length),f=[],n=0;a.forEach(function(g,m){pb.hasOwnProperty(g)?e[m]=pb[g]:(f.push(g),Fb.hasOwnProperty(g)||(Fb[g]=[]),Fb[g].push(function(){e[m]=pb[g];++n;n===f.length&&d(e)}))});0===f.length&&d(e)}
...
function X(b,a,c){c=c||{};if(!("argPackAdvance"in a))throw new TypeError("registerType registeredInstance requires argPackAdvance");var d=a.name;b||P('type "'+d+'" must have a positive integer typeid pointer');if(pb.hasOwnProperty(b)){if(c.nb)return;P("Cannot register type '"+d+"' twice")}pb[b]=a;delete Gb[b];Fb.hasOwnProperty(b)&&(a=Fb[b],delete Fb[b],a.forEach(function(e){e()}))}function Kb(b){P(b.V.Y.W.name+" instance already deleted")}function Lb(){}var Mb={};
function Nb(b,a,c){if(void 0===b[a].Z){var d=b[a];b[a]=function(){b[a].Z.hasOwnProperty(arguments.length)||P("Function '"+c+"' called with an invalid number of arguments ("+arguments.length+") - expects one of ("+b[a].Z+")!");return b[a].Z[arguments.length].apply(this,arguments)};b[a].Z=[];b[a].Z[d.ka]=d}}
function Ob(b,a,c){k.hasOwnProperty(b)?((void 0===c||void 0!==k[b].Z&&void 0!==k[b].Z[c])&&P("Cannot register public name '"+b+"' twice"),Nb(k,b,b),k.hasOwnProperty(c)&&P("Cannot register multiple overloads of a function with the same number of arguments ("+c+")!"),k[b].Z[c]=a):(k[b]=a,void 0!==c&&(k[b].Cb=c))}function Pb(b,a,c,d,e,f,n,g){this.name=b;this.constructor=a;this.fa=c;this.ia=d;this.aa=e;this.ib=f;this.oa=n;this.cb=g;this.Pa=[]}
function Qb(b,a,c){for(;a!==c;)a.oa||P("Expected null or instance of "+c.name+", got an instance of "+a.name),b=a.oa(b),a=a.aa;return b}function Rb(b,a){if(null===a)return this.za&&P("null is not a valid "+this.name),0;a.V||P('Cannot pass "'+Sb(a)+'" as a '+this.name);a.V.X||P("Cannot pass deleted object as a pointer of type "+this.name);return Qb(a.V.X,a.V.Y.W,this.W)}
function Tb(b,a){if(null===a){this.za&&P("null is not a valid "+this.name);if(this.sa){var c=this.Aa();null!==b&&b.push(this.ia,c);return c}return 0}a.V||P('Cannot pass "'+Sb(a)+'" as a '+this.name);a.V.X||P("Cannot pass deleted object as a pointer of type "+this.name);!this.ra&&a.V.Y.ra&&P("Cannot convert argument of type "+(a.V.da?a.V.da.name:a.V.Y.name)+" to parameter type "+this.name);c=Qb(a.V.X,a.V.Y.W,this.W);if(this.sa)switch(void 0===a.V.ba&&P("Passing raw pointer to smart pointer is illegal"),
this.zb){case 0:a.V.da===this?c=a.V.ba:P("Cannot convert argument of type "+(a.V.da?a.V.da.name:a.V.Y.name)+" to parameter type "+this.name);break;case 1:c=a.V.ba;break;case 2:if(a.V.da===this)c=a.V.ba;else{var d=a.clone();c=this.vb(c,Q(function(){d["delete"]()}));null!==b&&b.push(this.ia,c)}break;default:P("Unsupporting sharing policy")}return c}
function Ub(b,a){if(null===a)return this.za&&P("null is not a valid "+this.name),0;a.V||P('Cannot pass "'+Sb(a)+'" as a '+this.name);a.V.X||P("Cannot pass deleted object as a pointer of type "+this.name);a.V.Y.ra&&P("Cannot convert argument of type "+a.V.Y.name+" to parameter type "+this.name);return Qb(a.V.X,a.V.Y.W,this.W)}function Vb(b,a,c){if(a===c)return b;if(void 0===c.aa)return null;b=Vb(b,a,c.aa);return null===b?null:c.cb(b)}function Wb(b,a){a=ob(b,a);return nb[a]}
...
function Zb(b,a,c){k.hasOwnProperty(b)||Ib("Replacing nonexistant public symbol");void 0!==k[b].Z&&void 0!==c?k[b].Z[c]=a:(k[b]=a,k[b].ka=c)}function ac(b,a){var c=[];return function(){c.length=arguments.length;for(var d=0;d<arguments.length;d++)c[d]=arguments[d];b.includes("j")?(d=k["dynCall_"+b],d=c&&c.length?d.apply(null,[a].concat(c)):d.call(null,a)):d=Pa.get(a).apply(null,c);return d}}
function Z(b,a){b=V(b);var c=b.includes("j")?ac(b,a):Pa.get(a);"function"!==typeof c&&P("unknown function pointer with signature "+b+": "+a);return c}var bc=void 0;function cc(b,a){function c(f){e[f]||pb[f]||(Gb[f]?Gb[f].forEach(c):(d.push(f),e[f]=!0))}var d=[],e={};a.forEach(c);throw new bc(b+": "+d.map(qb).join([", "]));}
...
function ec(b,a,c,d,e){var f=a.length;2>f&&P("argTypes array size mismatch! Must at least get return value and 'this' types!");var n=null!==a[1]&&null!==c,g=!1;for(c=1;c<a.length;++c)if(null!==a[c]&&void 0===a[c].ca){g=!0;break}var m="void"!==a[0].name,h="",p="";for(c=0;c<f-2;++c)h+=(0!==c?", ":"")+"arg"+c,p+=(0!==c?", ":"")+"arg"+c+"Wired";b="return function "+cb(b)+"("+h+") {\nif (arguments.length !== "+(f-2)+") {\nthrowBindingError('function "+b+" called with ' + arguments.length + ' arguments, expected "+
(f-2)+" args!');\n}\n";g&&(b+="var destructors = [];\n");var u=g?"destructors":"null";h="throwBindingError invoker fn runDestructors retType classParam".split(" ");d=[P,d,e,Db,a[0],a[1]];n&&(b+="var thisWired = classParam.toWireType("+u+", this);\n");for(c=0;c<f-2;++c)b+="var arg"+c+"Wired = argType"+c+".toWireType("+u+", arg"+c+"); // "+a[c+2].name+"\n",h.push("argType"+c),d.push(a[c+2]);n&&(p="thisWired"+(0<p.length?", ":"")+p);b+=(m?"var rv = ":"")+"invoker(fn"+(0<p.length?", ":"")+p+");\n";if(g)b+=
...
function gc(b,a,c){b instanceof Object||P(c+' with invalid "this": '+b);b instanceof a.W.constructor||P(c+' incompatible with "this" of type '+b.constructor.name);b.V.X||P("cannot call emscripten binding method "+c+" on deleted object");return Qb(b.V.X,b.V.Y.W,a.W)}function hc(b){4<b&&0===--O[b].Ba&&(O[b]=void 0,eb.push(b))}
...
function kc(b,a,c){switch(a){case 0:return c?function(d){return La[d]}:function(d){return D[d]};case 1:return c?function(d){return Ea[d>>1]}:function(d){return Da[d>>1]};case 2:return c?function(d){return J[d>>2]}:function(d){return L[d>>2]};default:throw new TypeError("Unknown integer type: "+b);}}var lc={};function mc(b){var a=lc[b];return void 0===a?V(b):a}var nc=[];function oc(b){var a=nc.length;nc.push(b);return a}
function pc(b,a){for(var c=Array(b),d=0;d<b;++d)c[d]=xb(J[(a>>2)+d],"parameter "+d);return c}var qc=[],rc=[null,[],[]];gb=k.BindingError=fb("BindingError");k.count_emval_handles=function(){for(var b=0,a=5;a<O.length;++a)void 0!==O[a]&&++b;return b};k.get_first_emval=function(){for(var b=5;b<O.length;++b)if(void 0!==O[b])return O[b];return null};ib=k.PureVirtualError=fb("PureVirtualError");for(var sc=Array(256),tc=0;256>tc;++tc)sc[tc]=String.fromCharCode(tc);jb=sc;k.getInheritedInstanceCount=function(){return Object.keys(nb).length};
k.getLiveInheritedInstances=function(){var b=[],a;for(a in nb)nb.hasOwnProperty(a)&&b.push(nb[a]);return b};k.flushPendingDeletes=lb;k.setDelayFunction=function(b){mb=b;kb.length&&mb&&mb(lb)};Hb=k.InternalError=fb("InternalError");Lb.prototype.isAliasOf=function(b){if(!(this instanceof Lb&&b instanceof Lb))return!1;var a=this.V.Y.W,c=this.V.X,d=b.V.Y.W;for(b=b.V.X;a.aa;)c=a.oa(c),a=a.aa;for(;d.aa;)b=d.oa(b),d=d.aa;return a===d&&c===b};
Lb.prototype.clone=function(){this.V.X||Kb(this);if(this.V.na)return this.V.count.value+=1,this;var b=Bb,a=Object,c=a.create,d=Object.getPrototypeOf(this),e=this.V;b=b(c.call(a,d,{V:{value:{count:e.count,la:e.la,na:e.na,X:e.X,Y:e.Y,ba:e.ba,da:e.da}}}));b.V.count.value+=1;b.V.la=!1;return b};Lb.prototype["delete"]=function(){this.V.X||Kb(this);this.V.la&&!this.V.na&&P("Object already scheduled for deletion");yb(this);Ab(this.V);this.V.na||(this.V.ba=void 0,this.V.X=void 0)};
Lb.prototype.isDeleted=function(){return!this.V.X};Lb.prototype.deleteLater=function(){this.V.X||Kb(this);this.V.la&&!this.V.na&&P("Object already scheduled for deletion");kb.push(this);1===kb.length&&mb&&mb(lb);this.V.la=!0;return this};Yb.prototype.jb=function(b){this.Qa&&(b=this.Qa(b));return b};Yb.prototype.Ja=function(b){this.ia&&this.ia(b)};Yb.prototype.argPackAdvance=8;Yb.prototype.readValueFromPointer=Eb;Yb.prototype.deleteObject=function(b){if(null!==b)b["delete"]()};
...
var vc={n:function(b,a,c){b=V(b);a=xb(a,"wrapper");c=hb(c);var d=[].slice,e=a.W,f=e.fa,n=e.aa.fa,g=e.aa.constructor;b=db(b,function(){e.aa.Pa.forEach(function(h){if(this[h]===n[h])throw new ib("Pure virtual function "+h+" must be implemented in JavaScript");}.bind(this));Object.defineProperty(this,"__parent",{value:f});this.__construct.apply(this,d.call(arguments))});f.__construct=function(){this===f&&P("Pass correct 'this' to __construct");var h=g.implement.apply(void 0,[this].concat(d.call(arguments)));
yb(h);var p=h.V;h.notifyOnDestruction();p.na=!0;Object.defineProperties(this,{V:{value:p}});Bb(this);h=p.X;h=ob(e,h);nb.hasOwnProperty(h)?P("Tried to register registered instance: "+h):nb[h]=this};f.__destruct=function(){this===f&&P("Pass correct 'this' to __destruct");yb(this);var h=this.V.X;h=ob(e,h);nb.hasOwnProperty(h)?delete nb[h]:P("Tried to unregister unregistered instance: "+h)};b.prototype=Object.create(f);for(var m in c)b.prototype[m]=c[m];return Q(b)},K:function(b){var a=Cb[b];delete Cb[b];
...
p+'"');var u=c();for(p in g)g[p].write(u,h[p]);null!==m&&m.push(d,u);return u},argPackAdvance:8,readValueFromPointer:Eb,ca:d}]})},z:function(){},F:function(b,a,c,d,e){var f=Jb(c);a=V(a);X(b,{name:a,fromWireType:function(n){return!!n},toWireType:function(n,g){return g?d:e},argPackAdvance:8,readValueFromPointer:function(n){if(1===c)var g=La;else if(2===c)g=Ea;else if(4===c)g=J;else throw new TypeError("Unknown boolean type size: "+a);return this.fromWireType(g[n>>f])},ca:null})},c:function(b,a,c,d,
e,f,n,g,m,h,p,u,t){p=V(p);f=Z(e,f);g&&(g=Z(n,g));h&&(h=Z(m,h));t=Z(u,t);var x=cb(p);Ob(x,function(){cc("Cannot construct "+p+" due to unbound types",[d])});W([b,a,c],d?[d]:[],function(q){q=q[0];if(d){var F=q.W;var G=F.fa}else G=Lb.prototype;q=db(x,function(){if(Object.getPrototypeOf(this)!==v)throw new gb("Use 'new' to construct "+p);if(void 0===A.ja)throw new gb(p+" has no accessible constructor");var N=A.ja[arguments.length];if(void 0===N)throw new gb("Tried to invoke ctor of "+p+" with invalid number of parameters ("+
arguments.length+") - expected ("+Object.keys(A.ja).toString()+") parameters instead!");return N.apply(this,arguments)});var v=Object.create(G,{constructor:{value:q}});q.prototype=v;var A=new Pb(p,q,v,t,F,f,g,h);F=new Yb(p,A,!0,!1);G=new Yb(p+"*",A,!1,!1);var E=new Yb(p+" const*",A,!1,!0);Mb[b]={pointerType:G,$a:E};Zb(x,q);return[F,G,E]})},i:function(b,a,c,d,e,f,n){var g=fc(c,d);a=V(a);f=Z(e,f);W([],[b],function(m){function h(){cc("Cannot call "+p+" due to unbound types",g)}m=m[0];var p=m.name+"."+
a;a.startsWith("@@")&&(a=Symbol[a.substring(2)]);var u=m.W.constructor;void 0===u[a]?(h.ka=c-1,u[a]=h):(Nb(u,a,p),u[a].Z[c-1]=h);W([],g,function(t){t=ec(p,[t[0],null].concat(t.slice(1)),null,f,n);void 0===u[a].Z?(t.ka=c-1,u[a]=t):u[a].Z[c-1]=t;return[]});return[]})},f:function(b,a,c,d,e,f,n,g){a=V(a);f=Z(e,f);W([],[b],function(m){m=m[0];var h=m.name+"."+a,p={get:function(){cc("Cannot access "+h+" due to unbound types",[c])},enumerable:!0,configurable:!0};p.set=g?function(){cc("Cannot access "+h+" due to unbound types",
[c])}:function(){P(h+" is a read-only property")};Object.defineProperty(m.W.constructor,a,p);W([],[c],function(u){u=u[0];var t={get:function(){return u.fromWireType(f(d))},enumerable:!0};g&&(g=Z(n,g),t.set=function(x){var q=[];g(d,u.toWireType(q,x));Db(q)});Object.defineProperty(m.W.constructor,a,t);return[]});return[]})},l:function(b,a,c,d,e,f){0<a||va("Assertion failed: undefined");var n=fc(a,c);e=Z(d,e);W([],[b],function(g){g=g[0];var m="constructor "+g.name;void 0===g.W.ja&&(g.W.ja=[]);if(void 0!==
g.W.ja[a-1])throw new gb("Cannot register multiple constructors with identical number of parameters ("+(a-1)+") for class '"+g.name+"'! Overload resolution is currently only performed using the parameter count, not actual type info!");g.W.ja[a-1]=function(){cc("Cannot construct "+g.name+" due to unbound types",n)};W([],n,function(h){h.splice(1,0,null);g.W.ja[a-1]=ec(m,h,null,e,f);return[]});return[]})},a:function(b,a,c,d,e,f,n,g){var m=fc(c,d);a=V(a);f=Z(e,f);W([],[b],function(h){function p(){cc("Cannot call "+
u+" due to unbound types",m)}h=h[0];var u=h.name+"."+a;a.startsWith("@@")&&(a=Symbol[a.substring(2)]);g&&h.W.Pa.push(a);var t=h.W.fa,x=t[a];void 0===x||void 0===x.Z&&x.className!==h.name&&x.ka===c-2?(p.ka=c-2,p.className=h.name,t[a]=p):(Nb(t,a,u),t[a].Z[c-2]=p);W([],m,function(q){q=ec(u,q,h,f,n);void 0===t[a].Z?(q.ka=c-2,t[a]=q):t[a].Z[c-2]=q;return[]});return[]})},b:function(b,a,c,d,e,f,n,g,m,h){a=V(a);e=Z(d,e);W([],[b],function(p){p=p[0];var u=p.name+"."+a,t={get:function(){cc("Cannot access "+
u+" due to unbound types",[c,n])},enumerable:!0,configurable:!0};t.set=m?function(){cc("Cannot access "+u+" due to unbound types",[c,n])}:function(){P(u+" is a read-only property")};Object.defineProperty(p.W.fa,a,t);W([],m?[c,n]:[c],function(x){var q=x[0],F={get:function(){var v=gc(this,p,u+" getter");return q.fromWireType(e(f,v))},enumerable:!0};if(m){m=Z(g,m);var G=x[1];F.set=function(v){var A=gc(this,p,u+" setter"),E=[];m(h,A,G.toWireType(E,v));Db(E)}}Object.defineProperty(p.W.fa,a,F);return[]});
return[]})},E:function(b,a){a=V(a);X(b,{name:a,fromWireType:function(c){var d=hb(c);hc(c);return d},toWireType:function(c,d){return Q(d)},argPackAdvance:8,readValueFromPointer:Eb,ca:null})},k:function(b,a,c,d){function e(){}c=Jb(c);a=V(a);e.values={};X(b,{name:a,constructor:e,fromWireType:function(f){return this.constructor.values[f]},toWireType:function(f,n){return n.value},argPackAdvance:8,readValueFromPointer:ic(a,c,d),ca:null});Ob(a,e)},j:function(b,a,c){var d=xb(b,"enum");a=V(a);b=d.constructor;
d=Object.create(d.constructor.prototype,{value:{value:c},constructor:{value:db(d.name+"_"+a,function(){})}});b.values[c]=d;b[a]=d},s:function(b,a,c){c=Jb(c);a=V(a);X(b,{name:a,fromWireType:function(d){return d},toWireType:function(d,e){return e},argPackAdvance:8,readValueFromPointer:jc(a,c),ca:null})},r:function(b,a,c,d,e,f){var n=fc(a,c);b=V(b);e=Z(d,e);Ob(b,function(){cc("Cannot call "+b+" due to unbound types",n)},a-1);W([],n,function(g){Zb(b,ec(b,[g[0],null].concat(g.slice(1)),null,e,f),a-1);
return[]})},h:function(b,a,c,d,e){function f(h){return h}a=V(a);-1===e&&(e=4294967295);var n=Jb(c);if(0===d){var g=32-8*c;f=function(h){return h<<g>>>g}}var m=a.includes("unsigned");X(b,{name:a,fromWireType:f,toWireType:function(h,p){if("number"!==typeof p&&"boolean"!==typeof p)throw new TypeError('Cannot convert "'+Sb(p)+'" to '+this.name);if(p<d||p>e)throw new TypeError('Passing a number "'+Sb(p)+'" from JS side to C/C++ side to an argument of type "'+a+'", which is outside the valid range ['+d+
", "+e+"]!");return m?p>>>0:p|0},argPackAdvance:8,readValueFromPointer:kc(a,n,0!==d),ca:null})},g:function(b,a,c){function d(f){f>>=2;var n=L;return new e(Ka,n[f+1],n[f])}var e=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array][a];c=V(c);X(b,{name:c,fromWireType:d,argPackAdvance:8,readValueFromPointer:d},{nb:!0})},t:function(b,a){a=V(a);var c="std::string"===a;X(b,{name:a,fromWireType:function(d){var e=L[d>>2];if(c)for(var f=d+4,n=0;n<=e;++n){var g=d+4+
n;if(n==e||0==D[g]){f=f?za(D,f,g-f):"";if(void 0===m)var m=f;else m+=String.fromCharCode(0),m+=f;f=g+1}}else{m=Array(e);for(n=0;n<e;++n)m[n]=String.fromCharCode(D[d+4+n]);m=m.join("")}sb(d);return m},toWireType:function(d,e){e instanceof ArrayBuffer&&(e=new Uint8Array(e));var f="string"===typeof e;f||e instanceof Uint8Array||e instanceof Uint8ClampedArray||e instanceof Int8Array||P("Cannot pass non-string to std::string");var n=(c&&f?function(){for(var h=0,p=0;p<e.length;++p){var u=e.charCodeAt(p);
55296<=u&&57343>=u&&(u=65536+((u&1023)<<10)|e.charCodeAt(++p)&1023);127>=u?++h:h=2047>=u?h+2:65535>=u?h+3:h+4}return h}:function(){return e.length})(),g=uc(4+n+1);L[g>>2]=n;if(c&&f)Aa(e,g+4,n+1);else if(f)for(f=0;f<n;++f){var m=e.charCodeAt(f);255<m&&(sb(g),P("String has UTF-16 code units that do not fit in 8 bits"));D[g+4+f]=m}else for(f=0;f<n;++f)D[g+4+f]=e[f];null!==d&&d.push(sb,g);return g},argPackAdvance:8,readValueFromPointer:Eb,ca:function(d){sb(d)}})},q:function(b,a,c){c=V(c);if(2===a){var d=
Ca;var e=Fa;var f=Ga;var n=function(){return Da};var g=1}else 4===a&&(d=Ha,e=Ia,f=Ja,n=function(){return L},g=2);X(b,{name:c,fromWireType:function(m){for(var h=L[m>>2],p=n(),u,t=m+4,x=0;x<=h;++x){var q=m+4+x*a;if(x==h||0==p[q>>g])t=d(t,q-t),void 0===u?u=t:(u+=String.fromCharCode(0),u+=t),t=q+a}sb(m);return u},toWireType:function(m,h){"string"!==typeof h&&P("Cannot pass non-string to C++ string type "+c);var p=f(h),u=uc(4+p+a);L[u>>2]=p>>g;e(h,u+4,p+a);null!==m&&m.push(sb,u);return u},argPackAdvance:8,
readValueFromPointer:Eb,ca:function(m){sb(m)}})},L:function(b,a,c,d,e,f){Cb[b]={name:V(a),Aa:Z(c,d),ia:Z(e,f),Ma:[]}},I:function(b,a,c,d,e,f,n,g,m,h){Cb[b].Ma.push({gb:V(a),mb:c,kb:Z(d,e),lb:f,xb:n,wb:Z(g,m),yb:h})},G:function(b,a){a=V(a);X(b,{pb:!0,name:a,argPackAdvance:0,fromWireType:function(){},toWireType:function(){}})},m:function(b,a,c){b=hb(b);a=xb(a,"emval::as");var d=[],e=Q(d);J[c>>2]=e;return a.toWireType(d,b)},u:function(b,a,c,d,e){b=nc[b];a=hb(a);c=mc(c);var f=[];J[d>>2]=Q(f);return b(a,
c,f,e)},e:function(b,a,c,d){b=nc[b];a=hb(a);c=mc(c);b(a,c,null,d)},M:hc,d:function(b,a){var c=pc(b,a),d=c[0];a=d.name+"_$"+c.slice(1).map(function(p){return p.name}).join("_")+"$";var e=qc[a];if(void 0!==e)return e;e=["retType"];for(var f=[d],n="",g=0;g<b-1;++g)n+=(0!==g?", ":"")+"arg"+g,e.push("argType"+g),f.push(c[1+g]);var m="return function "+cb("methodCaller_"+a)+"(handle, name, destructors, args) {\n",h=0;for(g=0;g<b-1;++g)m+="    var arg"+g+" = argType"+g+".readValueFromPointer(args"+(h?"+"+
h:"")+");\n",h+=c[g+1].argPackAdvance;m+="    var rv = handle[name]("+n+");\n";for(g=0;g<b-1;++g)c[g+1].deleteObject&&(m+="    argType"+g+".deleteObject(arg"+g+");\n");d.pb||(m+="    return retType.toWireType(destructors, rv);\n");e.push(m+"};\n");b=dc(e).apply(null,f);e=oc(b);return qc[a]=e},H:function(b){b=mc(b);return Q(k[b])},J:function(b,a){b=hb(b);a=hb(a);return Q(b[a])},w:function(b){4<b&&(O[b].Ba+=1)},D:function(b){return Q(mc(b))},x:function(b){var a=hb(b);Db(a);hc(b)},o:function(b,a){b=
xb(b,"_emval_take_value");b=b.readValueFromPointer(a);return Q(b)},v:function(){va("")},p:function(b){var a=D.length;b>>>=0;if(2147483648<b)return!1;for(var c=1;4>=c;c*=2){var d=a*(1+.2/c);d=Math.min(d,b+100663296);d=Math.max(b,d);0<d%65536&&(d+=65536-d%65536);a:{try{wa.grow(Math.min(2147483648,d)-Ka.byteLength+65535>>>16);Oa();var e=1;break a}catch(f){}e=void 0}if(e)return!0}return!1},C:function(){return 0},y:function(){},B:function(b,a,c,d){for(var e=0,f=0;f<c;f++){var n=J[a>>2],g=J[a+4>>2];a+=
8;for(var m=0;m<g;m++){var h=D[n+m],p=rc[b];0===h||10===h?((1===b?qa:ra)(za(p,0)),p.length=0):p.push(h)}e+=g}J[d>>2]=e;return 0},A:function(){}};
(function(){function b(e){k.asm=e.exports;wa=k.asm.N;Oa();Pa=k.asm.T;Ra.unshift(k.asm.O);Ua--;k.monitorRunDependencies&&k.monitorRunDependencies(Ua);0==Ua&&(null!==Va&&(clearInterval(Va),Va=null),Wa&&(e=Wa,Wa=null,e()))}function a(e){b(e.instance)}function c(e){return $a().then(function(f){return WebAssembly.instantiate(f,d)}).then(function(f){return f}).then(e,function(f){ra("failed to asynchronously prepare wasm: "+f);va(f)})}var d={a:vc};Ua++;k.monitorRunDependencies&&k.monitorRunDependencies(Ua);
if(k.instantiateWasm)try{return k.instantiateWasm(d,b)}catch(e){return ra("Module.instantiateWasm callback failed with error: "+e),!1}(function(){return sa||"function"!==typeof WebAssembly.instantiateStreaming||Xa()||M.startsWith("file://")||"function"!==typeof fetch?c(a):fetch(M,{credentials:"same-origin"}).then(function(e){return WebAssembly.instantiateStreaming(e,d).then(a,function(f){ra("wasm streaming compile failed: "+f);ra("falling back to ArrayBuffer instantiation");return c(a)})})})().catch(ba);
return{}})();k.___wasm_call_ctors=function(){return(k.___wasm_call_ctors=k.asm.O).apply(null,arguments)};var sb=k._free=function(){return(sb=k._free=k.asm.P).apply(null,arguments)},uc=k._malloc=function(){return(uc=k._malloc=k.asm.Q).apply(null,arguments)},rb=k.___getTypeName=function(){return(rb=k.___getTypeName=k.asm.R).apply(null,arguments)};k.___embind_register_native_and_builtin_types=function(){return(k.___embind_register_native_and_builtin_types=k.asm.S).apply(null,arguments)};
k.dynCall_jiji=function(){return(k.dynCall_jiji=k.asm.U).apply(null,arguments)};var wc;Wa=function xc(){wc||yc();wc||(Wa=xc)};
function yc(){function b(){if(!wc&&(wc=!0,k.calledRun=!0,!xa)){ab(Ra);aa(k);if(k.onRuntimeInitialized)k.onRuntimeInitialized();if(k.postRun)for("function"==typeof k.postRun&&(k.postRun=[k.postRun]);k.postRun.length;){var a=k.postRun.shift();Sa.unshift(a)}ab(Sa)}}if(!(0<Ua)){if(k.preRun)for("function"==typeof k.preRun&&(k.preRun=[k.preRun]);k.preRun.length;)Ta();ab(Qa);0<Ua||(k.setStatus?(k.setStatus("Running..."),setTimeout(function(){setTimeout(function(){k.setStatus("")},1);b()},1)):b())}}
k.run=yc;if(k.preInit)for("function"==typeof k.preInit&&(k.preInit=[k.preInit]);0<k.preInit.length;)k.preInit.pop()();yc();
...
/* harmony export */ __nested_webpack_require_43563__.d(__webpack_exports__, {
/* harmony export */   "registerTouchInteractions": () => (/* reexport safe */ _registerTouchInteractions__WEBPACK_IMPORTED_MODULE_0__.registerTouchInteractions)
/* harmony export */ });
/* harmony import */ var _registerTouchInteractions__WEBPACK_IMPORTED_MODULE_0__ = __nested_webpack_require_43563__(4);
...
/* harmony export */ __nested_webpack_require_44069__.d(__webpack_exports__, {
...
/******/ 				if(__nested_webpack_require_46891__.o(definition, key) && !__nested_webpack_require_46891__.o(exports, key)) {
...
/* harmony export */ __nested_webpack_require_46891__.d(__webpack_exports__, {
...
/* harmony export */ });
/* harmony import */ var _rive_advanced_mjs__WEBPACK_IMPORTED_MODULE_0__ = __nested_webpack_require_46891__(1);
/* harmony import */ var package_json__WEBPACK_IMPORTED_MODULE_1__ = __nested_webpack_require_46891__(2);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __nested_webpack_require_46891__(3);
...
/* harmony export */ });
// Exports
var list = "index-module--list--+0B75";
var listItem = "index-module--listItem--BubbZ";
var listItemLink = "index-module--listItemLink--Asns5";
var listItemDescription = "index-module--listItemDescription--84dWA";
var textCenter = "index-module--textCenter--Ts42-";
var intro = "index-module--intro--C4dpM";
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gatsby */ "./.cache/gatsby-browser-entry.js");
/* harmony import */ var _rive_app_react_canvas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @rive-app/react-canvas */ "./node_modules/@rive-app/react-canvas/dist/index.js");
/* harmony import */ var _rive_app_react_canvas__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_rive_app_react_canvas__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _components_index_module_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/index.module.css */ "./src/components/index.module.css");
...
const IndexPage = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_3__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", null, "Hi"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement((_rive_app_react_canvas__WEBPACK_IMPORTED_MODULE_2___default()), {
  src: "/Users/brad/Documents/GitHub/tera.ws/src/pages/new_file-3.riv"
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement((_rive_app_react_canvas__WEBPACK_IMPORTED_MODULE_2___default()), {
